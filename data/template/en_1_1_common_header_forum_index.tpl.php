...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1605941206, '1', './data/template/en_1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1605941206, '1', './data/template/en_1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1605941206, '1', './data/template/en_1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
;?>
...
<!--vot--><script type="text/javascript">var LANG = '<?php echo DISCUZ_LANG;?>', LANGURL = '<?php echo $_G['siteurl'];?>source/language/<?php echo DISCUZ_LANG;?>/', LANGDIR = '<?php echo $_G['langdir'];?>', RTLSUFFIX = '<?php echo RTLSUFFIX;?>';</script>
...
<div class="xi1 bm bm_c">
    !your_mobile_browser!<a href="<?php echo $_G['siteurl'];?>forum.php?mobile=yes">!go_to_mobile!</a> <span class="xg1">|</span> <a href="<?php echo $_G['setting']['mobile']['nomobileurl'];?>">!to_be_continue!</a>
</div>
<?php } if($_G['setting']['shortcut'] && $_G['member']['credits'] >= $_G['setting']['shortcut']) { ?>
<div id="shortcut">
<span><a href="javascript:;" id="shortcutcloseid" title="!close!">!close!</a></span>
!shortcut_notice!
<a href="javascript:;" id="shortcuttip">!shortcut_add!</a>
...
<?php } } else { ?>
<a id="lslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'lslct','pos':'34!'})});" title="!change_language_title!">!change_language!<img class="flag" src="<?php echo $_G['langurl'];?><?php echo $_G['langicon'];?>"/></a>
...
<!--vot-->				<a id="switchblind" href="javascript:;" onclick="toggleBlind(this)" title="!switch_blind!" class="switchblind"><img src="<?php echo IMGDIR;?>/switch_blind.png"></a>
...
<!--vot-->					<a href="javascript:;" onclick="widthauto(this)" title="<?php if(widthauto()) { ?>!switch_narrow!<?php } else { ?>!switch_wide!<?php } ?>"><img src="<?php echo IMGDIR;?>/<?php if(widthauto()) { ?>shrink<?php } else { ?>expand<?php } ?>.png"></a>
<!--vot-->					<span class="pipe">|</span>
<?php } ?>
<!--vot-->				<?php if(!empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});" title="!changestyle_title!">!changestyle!<img src="<?php echo IMGDIR;?>/style_switch.png"></a><?php } if(check_diy_perm($topic)) { ?>
<?php echo $diynav;?>
<?php } ?>
</div>
</div>
...
<li><a href="home.php?mod=space&amp;do=pm" id="pm_ntc" style="background-repeat: no-repeat; background-position: 0 50%;"><em class="prompt_news<?php if(empty($_G['member']['newpm'])) { ?>_0<?php } ?>"></em>!pm_center!</a></li>
<li><a href="home.php?mod=follow&amp;do=follower"><em class="prompt_follower<?php if(empty($_G['member']['newprompt_num']['follower'])) { ?>_0<?php } ?>"></em>!notice_interactive_follower!<?php if($_G['member']['newprompt_num']['follower']) { ?>(<?php echo $_G['member']['newprompt_num']['follower'];?>)<?php } ?></a></li>
<?php if($_G['member']['newprompt'] && $_G['member']['newprompt_num']['follow']) { ?>
<li><a href="home.php?mod=follow"><em class="prompt_concern"></em>!notice_interactive_follow!(<?php echo $_G['member']['newprompt_num']['follow'];?>)</a></li>
...
<li class="ignore_noticeli"><a href="javascript:;" onclick="setcookie('ignore_notice', 1);hideMenu('myprompt_menu')" title="!temporarily_to_remind!"><em class="ignore_notice"></em></a></li>
<?php } ?>
</ul>
<?php } ?>
<!--vot-->		<?php if(!empty($_G['style']['extstyle'])) { ?>
<div id="sslct_menu" class="cl p_pop" style="display: none;">
<!--vot-->				<?php if(!$_G['style']['defaultextstyle']) { ?><a class="sslct_btn" onclick="extstyle('')"><i></i>!default!</a><?php } if(is_array($_G['style']['extstyle'])) foreach($_G['style']['extstyle'] as $extstyle) { ?><!--vot-->					<a class="sslct_btn" onclick="extstyle('<?php echo $extstyle['0'];?>')"><i style='background:<?php echo $extstyle['2'];?>'></i><?php echo $extstyle['1'];?></a>
<?php } ?>
</div>
<?php } if($_G['uid']) { ?>
<ul id="myitem_menu" class="p_pop" style="display: none;">
<li><a href="forum.php?mod=guide&amp;view=my">!mypost!</a></li>
<li><a href="home.php?mod=space&amp;do=favorite&amp;view=me">!favorite!</a></li>
<li><a href="home.php?mod=space&amp;do=friend">!friends!</a></li>
...
<div id="nv">
<!--vot-->				<a href="javascript:;" id="qmenu" onmouseover="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'<?php if($_G['langdir']=='rtl') { ?>43<?php } else { ?>34<?php } ?>!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})">!my_nav!</a>
...
$slist[forumfid] = <<<EOF
<li><a href="javascript:;" rel="curforum" fid="{$_G['fid']}" >!search_this_forum!</a></li>
EOF;
?><?php } if($_G['setting']['portalstatus'] && $_G['setting']['search']['portal']['status'] && ($_G['group']['allowsearch'] & 1 || $_G['adminid'] == 1)) { ?><?php
$slist[portal] = <<<EOF
<li><a href="javascript:;" rel="article">!article!</a></li>
EOF;
...
<td class="scbar_txt_td"><input type="text" name="srchtxt" id="scbar_txt" placeholder="!enter_content!" autocomplete="off" x-webkit-speech speech /></td>
...
<strong class="xw1">!hot_search!: </strong><?php if(is_array($_G['setting']['srchhotkeywords'])) foreach($_G['setting']['srchhotkeywords'] as $val) { if($val=trim($val)) { $valenc=rawurlencode($val);?><?php
