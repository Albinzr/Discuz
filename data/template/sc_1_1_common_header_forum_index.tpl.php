...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1605943877, '1', './data/template/sc_1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1605943877, '1', './data/template/sc_1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1605943877, '1', './data/template/sc_1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
;?>
...
<?php } } else { ?>
<a id="lslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'lslct','pos':'34!'})});" title="更改语言"><img class="flag" src="<?php echo $_G['langurl'];?><?php echo $_G['langicon'];?>"/></a>
...
<!--vot-->				<a id="switchblind" href="javascript:;" onclick="toggleBlind(this)" title="开启辅助访问" class="switchblind"><img src="<?php echo IMGDIR;?>/switch_blind.png"></a>
...
<!--vot-->					<a href="javascript:;" onclick="widthauto(this)" title="<?php if(widthauto()) { ?>切换到窄版<?php } else { ?>切换到宽版<?php } ?>"><img src="<?php echo IMGDIR;?>/<?php if(widthauto()) { ?>shrink<?php } else { ?>expand<?php } ?>.png"></a>
<!--vot-->					<span class="pipe">|</span>
<?php } ?>
<!--vot-->				<?php if(!empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});" title="切换风格">切换风格<img src="<?php echo IMGDIR;?>/style_switch.png"></a><?php } if(check_diy_perm($topic)) { ?>
<?php echo $diynav;?>
<?php } ?>
</div>
</div>
...
<!--vot-->				<?php if(!$_G['style']['defaultextstyle']) { ?><a class="sslct_btn" onclick="extstyle('')"><i></i>默认</a><?php } if(is_array($_G['style']['extstyle'])) foreach($_G['style']['extstyle'] as $extstyle) { ?><!--vot-->					<a class="sslct_btn" onclick="extstyle('<?php echo $extstyle['0'];?>')"><i style='background:<?php echo $extstyle['2'];?>'></i><?php echo $extstyle['1'];?></a>
<?php } ?>
</div>
<?php } if($_G['uid']) { ?>
...
<div id="nv">
<!--vot-->				<a href="javascript:;" id="qmenu" onmouseover="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'<?php if($_G['langdir']=='rtl') { ?>43<?php } else { ?>34<?php } ?>!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})">快捷导航</a>
