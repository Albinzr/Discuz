...
<p class="chart z">today: <em><?php echo $todayposts;?></em><span class="pipe">|</span>yesterday: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>Posts: <em><?php echo $posts;?></em><span class="pipe">|</span>members: <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['cache']['userstats']['newsetuser']) { ?><span class="pipe">|</span>Welcome new members: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank" class="xi2"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></em><?php } ?></p>
<div class="y">
<?php if(!empty($_G['setting']['pluginhooks']['index_nav_extra'])) echo $_G['setting']['pluginhooks']['index_nav_extra'];?>
<?php if($_G['uid']) { ?><a href="forum.php?mod=guide&amp;view=my" title="My posts" class="xi2">My posts</a><?php } if(!empty($_G['setting']['search']['forum']['status'])) { if($_G['uid']) { ?><span class="pipe">|</span><?php } ?><a href="forum.php?mod=guide&amp;view=new" title="Latest reply" class="xi2">Latest reply</a><?php } ?>
</div>
</div>
<?php } ?>
...
<h4><span class="tit_subject"></span>latest thread</h4>
...
<li><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>"<?php if($thread['highlight']) { ?> <?php echo $thread['highlight'];?><?php } if($_G['setting']['grid']['showtips']) { ?> tip="title: <strong><?php echo $thread['oldsubject'];?></strong><br/>author: <?php echo $thread['author'];?> (<?php echo $thread['dateline'];?>)<br/>view/reply: <?php echo $thread['views'];?>/<?php echo $thread['replies'];?>" onmouseover="showTip(this)"<?php } else { ?> title="<?php echo $thread['oldsubject'];?>"<?php } if($_G['setting']['grid']['targetblank']) { ?> target="_blank"<?php } ?>><?php echo $thread['subject'];?></a></li>
<?php } ?>
         </ul>
         </div>
</td>
...
<div class="replaybox">
<h4><span class="tit_replay"></span>Latest reply</h4>
        <ul class="category_newlist">
...
<li><a href="forum.php?mod=redirect&amp;tid=<?php echo $thread['tid'];?>&amp;goto=lastpost#lastpost"<?php if($thread['highlight']) { ?> <?php echo $thread['highlight'];?><?php } if($_G['setting']['grid']['showtips']) { ?>tip="title: <strong><?php echo $thread['oldsubject'];?></strong><br/>author: <?php echo $thread['author'];?> (<?php echo $thread['dateline'];?>)<br/>view/reply: <?php echo $thread['views'];?>/<?php echo $thread['replies'];?>" onmouseover="showTip(this)"<?php } else { ?> title="<?php echo $thread['oldsubject'];?>"<?php } if($_G['setting']['grid']['targetblank']) { ?> target="_blank"<?php } ?>><?php echo $thread['subject'];?></a></li>
<?php } ?>
         </ul>
         </div>
</td>
<td valign="top" class="category_l3">
<div class="hottiebox">
<h4><span class="tit_hottie"></span>hot thread</h4>
        <ul class="category_newlist">
...
<h4><span class="tit_goodtie"></span>Essence post</h4>
...
<div class="bm_h cl">
<span class="o">
<img id="category_-1_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-1'];?>" title="Collapse/Expand" alt="Collapse/Expand" onclick="toggle_collapse('category_-1');" />
</span>
<h2><a href="forum.php?mod=collection&amp;op=my">I subscribed album</a></h2>
</div>
...
<dd><em>topic: <?php echo dnumber($colletion['threadnum']); ?></em>, <em>comment: <?php echo dnumber($colletion['commentnum']); ?></em></dd>
<dd>
...
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $colletion['lastpost'];?>&amp;goto=lastpost#lastpost">last post: <?php echo dgmdate($colletion[lastposttime]);?></a>
<?php } } else { ?>
never
<?php } ?>
</dd>
...
<div class="bm_h cl">
<span class="o">
<img id="category_0_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_0'];?>" title="Collapse/Expand" alt="Collapse/Expand" onclick="toggle_collapse('category_0');" />
</span>
<h2><a href="home.php?mod=space&amp;do=favorite&amp;type=forum">My favorite forum</a></h2>
</div>
...
<?php echo $forum['icon'];?>
<?php } else { ?>
<!--vot-->									<a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } ?> class="icon_forum<?php if($forum['folder']) { ?>_new<?php } ?>" title="<?php echo $forum['name'];?>"></a>
<?php } ?>
</div>
...
<?php if(empty($forum['redirect'])) { ?><dd><em>topic: <?php echo dnumber($forum['threads']); ?></em>, <em>Number of posts : <?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
<dd>
<?php if($forum['permission'] == 1) { ?>
private forum
<?php } else { if($forum['redirect']) { ?>
<a href="<?php echo $forumurl;?>" class="xi2">Link to an external address</a>
...
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost">last post: <?php echo $forum['lastpost']['dateline'];?></a>
<?php } } else { ?>
never
<?php } } ?>
</dd>
...
<?php if($forum['description']) { ?><p class="xg2"><?php echo $forum['description'];?></p><?php } if($forum['subforums']) { ?><p>Subforums : <?php echo $forum['subforums'];?></p><?php } if($forum['moderators']) { ?><p>Moderators: <span class="xi2"><?php echo $forum['moderators'];?></span></p><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]])) echo $_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]];?>
</td>
<td class="fl_i">
...
<div class="bm_h cl">
<span class="o">
<img id="category_<?php echo $cat['fid'];?>_img" src="<?php echo IMGDIR;?>/<?php echo $cat['collapseimg'];?>" title="Collapse/Expand" alt="Collapse/Expand" onclick="toggle_collapse('category_<?php echo $cat['fid'];?>');" />
</span>
<?php if($cat['moderators']) { ?><span class="y">partition moderator: <?php echo $cat['moderators'];?></span><?php } $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? $_G['scheme'].'://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?><h2><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>"><?php echo $cat['name'];?></a></h2>
</div>
...
<div class="bm_h cl">
<span class="o">
<img id="category_-2_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-2'];?>" title="Collapse/Expand" alt="Collapse/Expand" onclick="toggle_collapse('category_-2');" />
</span>
<h2><a href="forum.php?mod=collection">Amoy album recommendation</a></h2>
</div>
...
<td class="fl_g"<?php if($forumcolwidth) { ?> width="<?php echo $forumcolwidth;?>"<?php } ?>>
<div class="fl_icn_g">
<!--vot-->								<a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $colletion['ctid'];?>" target="_blank" class="icon_forum" title="<?php echo $colletion['name'];?>"></a>
</div>
<dl>
<dt><a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $colletion['ctid'];?>"><?php echo $colletion['name'];?></a></dt>
<dd><em>topic: <?php echo dnumber($colletion['threadnum']); ?></em>, <em>comment: <?php echo dnumber($colletion['commentnum']); ?></em></dd>
...
<div class="bm_h">
<?php if($detailstatus) { ?>
<span class="o"><a href="forum.php?showoldetails=no#online" title="Collapse/Expand"><img src="<?php echo IMGDIR;?>/collapsed_no.gif" alt="Collapse/Expand" /></a></span>
<h3>
<strong><a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">online member</a></strong>
<!--vot-->					<span class="xs1">- <strong><?php echo $onlinenum;?></strong> &nbsp;
<!--vot-->					( members: <strong><?php echo $membercount;?></strong>, invisibles: <strong><?php echo $invisiblecount;?></strong>,
<!--vot-->					Guests: <strong><?php echo $guestcount;?></strong> )
<!--vot-->					- The highest record is: <strong><?php echo $onlineinfo['0'];?></strong> 于 <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } else { if(empty($_G['setting']['sessionclose'])) { ?>
<span class="o"><a href="forum.php?showoldetails=yes#online" title="Collapse/Expand"><img src="<?php echo IMGDIR;?>/collapsed_yes.gif" alt="Collapse/Expand" /></a></span>
<?php } ?>
<h3>
<strong>
...
online member
<?php } else { ?>
<a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">online member</a>
<?php } ?>
</strong>
<span class="xs1">- total <strong><?php echo $onlinenum;?></strong> people online
<?php if($membercount) { ?>- <strong><?php echo $membercount;?></strong> members,<strong><?php echo $guestcount;?></strong> Guests<?php } ?>
- The highest record is <strong><?php echo $onlineinfo['0'];?></strong> 于 <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } ?>
</div>
...
<dd class="ptm pbm">
<ul class="cl">
<?php if($whosonline) { if(is_array($whosonline)) foreach($whosonline as $key => $online) { ?><li title="time: <?php echo $online['lastactivity'];?>">
...
<?php } } else { ?>
<li style="width: auto">Currently only tourists or invisible members are online</li>
<?php } ?>
</ul>
</dd>
<?php } ?>
